...
caseSuffix =''; % used for input, output & particlePositions
caseSuffix_additional =''; % used for input and output file directly after 'caseSuffix'

caseNameGraph = 'View0.10Deg'; % Casename for graph

inputdirectory = '/net/users/kevinvanas/OptoFluids/Simulations/Optics/cylinderA/resolutionStudy/view0.10deg/';
outputdirectory = '/net/users/kevinvanas/OptoFluids/Simulations/Optics/cylinderA/resolutionStudy/view0.10deg/results/';
coordsFile = strcat(outputdirectory,'PixelCoords_257x257',caseSuffix,caseSuffix_additional,'.out');
intensityFile = strcat(outputdirectory,'Intensity_257x257',caseSuffix,caseSuffix_additional,'.out');
particlePositionsFile = strcat(inputdirectory,'particlePositions_t9.txt',caseSuffix);
